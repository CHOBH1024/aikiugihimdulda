...
// 1. Fix scripts
html = html.replace('<script src="/data.js"></script>', '<script src="chemistry_data.js"></script>\n    <script src="data.js"></script>');

// 2. Fix navigator share
...
html = html.replace(\`우리가 그토록 아프게 뼈를 때렸는데도, 당신은 창을 닫지 않고 여기까지 스크롤을 내렸습니다.<br><br>
                왜일까요?<br>
                ...
                고생하셨습니다. 당신은 이미 충분히 좋은 부모입니다.\`, \`누구도 완벽한 정답을 알려주지 않는 육아의 여정에서, 끊임없이 고민하며 여기까지 글을 읽어오셨습니다.<br><br>
...
console.log('Applied all fixes to result.html');
